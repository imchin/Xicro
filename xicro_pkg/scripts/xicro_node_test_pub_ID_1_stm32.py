...
def setup_var_protocol():
    ...
    return [1],['publish_from_Stm32'],['std_msgs/UInt8.msg'],[['uint8']],[['data']],[[0]],[[1]],[[8]],[[1]]
...
def Receive_uart(Obj_uart): #processer 1
    ...
    while(1):
        ...
        try:
            ...
            count=count+1
            if(time.time_ns()-timee>=1000000000):
                timee=time.time_ns()
                print("Recive Uart :",count ,"bytes per second.")
                count=0
        except:
            1
